...
#define OV5642_FOCUSZONE_MAX_ROI_NUM  1 // max focus ROI number supported by sensor, which is only valid under CAM_FOCUSZONEMODE_MANUAL mode
#else
#define OV5642_FOCUSZONE_MAX_ROI_NUM  0
#endif

#define OV5642_EXPMETER_MAX_ROI_NUM   1 // max metering ROI number supported by sensor, which is only valid under CAM_EXPOSUREMETERMODE_MANUAL mode
...
#endif
#if defined( BUILD_OPTION_STRATEGY_ENABLE_AUTOFOCUS )
    .eFocusMode          = CAM_FOCUS_AUTO_ONESHOT,
    .eFocusZoneMode      = CAM_FOCUSZONEMODE_CENTER,
#else
    .eFocusMode          = CAM_FOCUS_INFINITY,
    .eFocusZoneMode      = -1,
#endif
    .stFocusROI          = {0,{{{0, 0, 0, 0}, 0}}},
    .eStillSubMode       = CAM_STILLSUBMODE_SIMPLE,
    .stStillSubModeParam = { 1, 0 },
    .eVideoSubMode       = CAM_VIDEOSUBMODE_SIMPLE,
    .iDigZoomQ16         = 1 << 16,
    .iOptZoomQ16         = 1 << 16,
    .iSaturation         = 64,
    .iBrightness         = 0,
...
#define OV5642_FOCUS_STA_FOCUSED        0x10
#define OV5642_FOCUS_STA_FOCUSING       0x00
#define OV5642_FOCUS_STA_STARTUP        0x7e
#define OV5642_FOCUS_STA_IDLE           0x70
#define OV5642_FOCUS_CMD_COMPLETED      0X00
...
#define OV5642_FACEDETECTION_MAXFACENUM  5
// OV5642 registers
...
#define OV5642_REG_AF_ACK                 0x3025,0,7,0
#define OV5642_REG_AF_PARA0               0x5082,0,7,0
#define OV5642_REG_AF_PARA1               0x5083,0,7,0
#define OV5642_REG_AF_PARA2               0x5084,0,7,0
#define OV5642_REG_AF_PARA3               0x5085,0,7,0
#define OV5642_REG_AF_PARA4               0x3026,0,7,0
...
typedef struct
{
	double      dExpVal; // exposure value: multiple of exposure time and gain
	CAM_Int16u  iAWBGainR;
	CAM_Int16u  iAWBGainG;
	CAM_Int16u  iAWBGainB;
} _OV5642_3AState;
...
typedef struct
{
	...
	void                *hFaceBufWriteMutex;
	CAM_Thread          stFaceDetectThread;
