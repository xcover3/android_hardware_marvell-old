...
/*
 * Contains declaration of a class YUYVJpegCompressor that encapsulates a
 ...
 */
class YUYVJpegCompressor : protected Yuv422IToJpegEncoder
{
public:
...
public:
    /* Compresses raw YUYV image into a JPEG.
