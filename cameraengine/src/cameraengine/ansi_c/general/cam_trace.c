...
CAM_CmdInfo stCmdInfo[] =
{
	...
	// frame rate
	{ CAM_CMD_SET_FRAMERATE,            "CAM_CMD_SET_FRAMERATE"},
	{ CAM_CMD_GET_FRAMERATE,            "CAM_CMD_GET_FRAMERATE"},
	...
	// video sub-mode    
	{ CAM_CMD_SET_VIDEO_SUBMODE,        "CAM_CMD_SET_VIDEO_SUBMODE"},
	{ CAM_CMD_GET_VIDEO_SUBMODE,        "CAM_CMD_GET_VIDEO_SUBMODE"},
	// still submode  
	{ CAM_CMD_SET_STILL_SUBMODE,        "CAM_CMD_SET_STILL_SUBMODE"},
	{ CAM_CMD_GET_STILL_SUBMODE,        "CAM_CMD_GET_STILL_SUBMODE"},
...
void _cam_devtrace( void *pCameraState )
{
	...
	{
		CAMTRACE( pTraceFp, "Error: your device is NULL( %s, %s, %d )\n", __FILE__, __FUNCTION__, __LINE__ );
		TRACEFLUSH( pTraceFp );
	}
	return;
}
...
void _cam_rettrace( CAM_Command cmd, void *arg1, void *arg2, CAM_Error eErrorNo, CAM_Tick tTick )
{
	...
	tTick = CAM_TimeGetTickCount() - tTick;
