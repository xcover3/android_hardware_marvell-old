...
typedef enum {
	...
	CFG_AUXAEC_MODE_IPPENUM_FORCE32BIT_RESERVE = 0x7fffffff
}CFG_AUXAEC_MODE;
...
typedef enum{
	...
	CFG_HO_TYPE_IPPENUM_FORCE32BIT_RESERVE = 0x7fffffff
}CFG_HO_TYPE;
...
typedef enum{
	...
	CFG_VOICEBAND_TYPE_IPPENUM_FORCE32BIT_RESERVE = 0x7fffffff
}CFG_VOICEBAND_TYPE;
...
typedef enum {
	...
	CFG_PATH_IPPENUM_FORCE32BIT_RESERVE = 0x7fffffff
}CFG_PATH;
...
typedef enum {
	...
	VPCMD_IPPENUM_FORCE32BIT_RESERVE = 0x7fffffff
} VPCMD;
...
typedef enum
{
  ...
  FDITABLETYPENAME_IPPENUM_FORCE32BIT_RESERVE = 0x7fffffff
}FdiTableTypeName;
