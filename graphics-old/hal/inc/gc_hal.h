...
typedef enum _gceBROADCAST
{
    ...
    /* Power off GPU if idle for a period of time. */
    gcvBROADCAST_POWER_OFF_TIMEOUT,
#endif
...
gckHARDWARE_Link(
    IN gckHARDWARE Hardware,
    IN gctPOINTER Logical,
    IN gctPOINTER FetchAddressBase,
...
/* Convert logical address to hardware specific address.or get hardware specific address by mdl */
gceSTATUS
gckHARDWARE_ConvertLogicalMdl(
    IN gckHARDWARE Hardware,
    IN gctPOINTER Logical,
    OUT gctUINT32 * Address,
    IN gctPHYS_ADDR  Physmdl
