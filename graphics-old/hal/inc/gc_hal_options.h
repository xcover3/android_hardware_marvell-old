...
#define MRVL_CONFIG_SHADER_CLK_CONTROL          0
    ...
    MRVL_PLATFORM_PXA1088 || MRVL_PLATFORM_PXA1L88
 ...
 */
    ...
    ((MRVL_PLATFORM_988) || (MRVL_PLATFORM_PXA1088) || (MRVL_PLATFORM_PXA1L88))
...
*/
#if (defined ANDROID)  && (!VIVANTE_PROFILER) && ((MRVL_PLATFORM_NEVO) || \
    (MRVL_PLATFORM_988) || (MRVL_PLATFORM_PXA1088) || (MRVL_PLATFORM_PXA1L88))
...
*/
#if (defined CONFIG_PM_RUNTIME) && ((MRVL_PLATFORM_988) || (MRVL_PLATFORM_PXA1088))
...
*/
    ...
    && ((MRVL_PLATFORM_NEVO) || (MRVL_PLATFORM_988) || (MRVL_PLATFORM_PXA1088) || (MRVL_PLATFORM_PXA1L88))
#define MRVL_CONFIG_ENABLE_GPUFREQ              1
#else
#define MRVL_CONFIG_ENABLE_GPUFREQ              0
#endif

#if (defined ANDROID) && (MRVL_PLATFORM_988 || MRVL_PLATFORM_PXA1088)
...
#if MRVL_PLATFORM_PXA1088 || MRVL_PLATFORM_PXA1L88
...
#define gcdENABLE_SET_LIMITED_OUTSTANDING       0
#else
...
#define _GC_VERSION_STRING_                     "GC Ver rls_pxa988_JB43_GC6_kk"
