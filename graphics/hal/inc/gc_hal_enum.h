...
/* Pulse Eater(DVFS) Control. */
typedef enum _gceDVFS
{
    gcvDVFS_DISABLE = 0,
    gcvDVFS_ENABLE_INTERNAL,    /* enable pulse eater count, and set to hw */
    gcvDVFS_ENABLE_EXTERNAL     /* enable pulse eater count, but NOT set to hw */
}
gceDVFS;
...
typedef enum _gce2D_STATE
{
    ...
    gcv2D_STATE_OPF_BLOCK_WALK_CONFIG,
    gcv2D_STATE_OPF_BLOCK_WALK_LINEAR_ROT_OPT,
    gcv2D_STATE_OPF_BLOCK_WALK_BLOCK_DIR_T2B,
    gcv2D_STATE_OPF_BLOCK_WALK_PIXEL_DIR_T2B,
    gcv2D_STATE_OPF_BLOCK_WALK_BLOCK_W_SIZE,
    gcv2D_STATE_OPF_BLOCK_WALK_BLOCK_H_SIZE,
    gcv2D_STATE_OPF_VERTICAL_MASK,
    gcv2D_STATE_OPF_HORIZONTAL_MASK,
#endif
